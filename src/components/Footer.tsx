                            ...
                            <div className="col-lg-6 col-md-6 col-sm-12 footer-column">
                                <div className="logo-widget footer-widget mx-auto">
                                    ...
                                    <ul className="footer-social ulist ">
                                        ...
                                        <li><a href="https://www.instagram.com/hackfestiitism/?hl=en" target="_blank"><i className="fab fa-instagram link"></i></a></li>
                                        <li><a href="https://www.linkedin.com/company/hackfest-iit-ism-dhanbad/?originalSubdomain=in" target="_blank"><i className="fab fa-linkedin link"></i></a></li>
                                    </ul>
                                </div>
                            </div>
